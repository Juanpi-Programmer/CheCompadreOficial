    ...
    <div class="disc-flex" id="mus">
        <div class="music-disc" id="fuerte_impacto">
            ...
            <div class="reproduccion">
                <a href="#reproducir" id="reprodFuerteImpacto" class="reprodFuerte reprod"><i class="fa fa-play-circle" aria-hidden="true"></i></a>
                <a href="#exit" id="exDiscFuerte" class="reprodFuerte reprod"><i class="far fa-times-circle"></i></a>
                <a href="http://checompadre.bandcamp.com/album/cultura-presente" target="_blank" class="reprod"><i class="fa fa-cart-arrow-down" aria-hidden="true"></i></a>
            </div>
        </div>
